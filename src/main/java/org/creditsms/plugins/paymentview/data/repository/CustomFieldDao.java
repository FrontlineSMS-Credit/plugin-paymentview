...
public interface CustomFieldDao {
	...
	/**
	 * Returns all CustomFields from a particular start index with a maximum number of returned CustomFields set.
	 * @param startIndex index of the first CustomField to fetch
	 * @param limit Maximum number of CustomFields to fetch from the start index
	 * @return
	 */
	public List<CustomField> getAllCustomFields(int startIndex, int limit);
	
	/**
	 * Returns a list of CustomFields whose name is similar to the specified string
	 * @param srtname string to be used to match the names
	 * @return
	 */
	public List<CustomField> getCustomFieldsByName(String strName);
	
	/**
	 * Returns a list of CustomFields whose name is similar to the specified string from a particular
	 * start index with a maximum number of returned CustomFields set
	 * @param srtName 
	 * @param startIndex 
	 * @param limit
	 * @return
	 */
	public List<CustomField> getCustomFieldsByName(String strName, int startIndex, int limit);
